      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Card sx={{ borderRadius: "15px", overflow: "hidden" }}>
              <CardMedia
                ...
                image={
                  selectedImage ||
                  "https://placehold.co/600x450/F5EFE6/5D4037?text=No+Image"
                }
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Chip
                label={product.categories?.name || "Uncategorized"}
                sx={{
              ...
              <Typography
                variant="h4"
                sx={{ color: theme.primaryText, fontWeight: "bold", mb: 3 }}
              >
                Rs {product.price}
              </Typography>
              ...
              <Box sx={{ display: "flex", gap: 2, mb: 4 }}>
                ...
                <IconButton
                  ...
                  sx={{ border: `1px solid ${theme.primaryText}` }}
                >
                  {isFavorite ? (
                    <Favorite sx={{ color: "red" }} />
                  ) : (
                    <FavoriteBorder sx={{ color: theme.primaryText }} />
                  )}
                </IconButton>
              </Box>
              ...
              {shop && (
                ...
                >
                  <Typography sx={{ color: theme.secondaryText, mb: 1 }}>
                    Shop Name:
                  </Typography>
